...
<div class="<?php noo_main_class(); ?> job-detail-3" role="main">
    <?php if ( $is_expired ) : ?>
				...
				<?php else : ?>
                    ...
                    <?php if(!empty($apply_url)) : ?>
                        <a class="btn btn-primary" href="<?php echo esc_url( $apply_url ); ?>"
                           target="_blank"><?php echo jm_job_single_apply_text(true); ?></a>
                    <?php else:?>
                    	<a class="btn btn-primary" data-target="#applyJobModal" href="#"
                           data-toggle="modal"><?php echo jm_job_single_apply_text(); ?></a>
