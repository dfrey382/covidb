                        ...
                        <div class="pricing-info">
                            <ul class="noo-ul-icon fa-ul">
                                ...
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon job-posting"><i class="fa fa-check-circle"></i> <?php echo esc_html($job_posting_text); ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon job-posting noo-li-not-good"><i class="far fa-times-circle not-good"></i> <?php esc_html_e('Job posting', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($featured_limit > 0) : ?>
                                    <li class="noo-li-icon featured-job"><i class="fa fa-check-circle"></i> <?php echo esc_html($job_featured_text); ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon featured-job noo-li-not-good"><i  class="far fa-times-circle not-good"></i> <?php esc_html_e('Featured job', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($refresh_limit > 0) : ?>
                                    <li class="noo-li-icon job-refresh"><i class="fa fa-check-circle"></i> <?php echo esc_html($job_refresh_text); ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon job-refresh noo-li-not-good"><i class="far fa-times-circle not-good"></i> <?php esc_html_e('Refresh job', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if($download_resume_limit == 99999999): ?>
                                    <li class="noo-li-icon download-resume"><i class="fa fa-check-circle"></i><?php esc_html_e('Unlimited download resume', 'noo'); ?></li>
                                <?php elseif($download_resume_limit == 'not_download'): ?>
                                    <li class="noo-li-icon download-resume noo-li-not-good"><i class="far fa-times-circle not-good"></i><?php esc_html_e('Download Resume Attach file','noo') ?></li>
                                <?php elseif($download_resume_limit == 'not_package'): ?>
                                <?php else: ?>
                                    <li class="noo-li-icon download-resume"><i class="fa fa-check-circle"></i><?php echo sprintf(_n('%s download resume ','%s download resumes ',$download_resume_limit,'noo'),$download_resume_limit); ?></li>
                                <?php endif; ?>
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon job-duration"><i  class="fa fa-check-circle"></i> <?php echo esc_html($job_duration_text); ?></li>
                                <?php endif; ?>
                                <?php if ($company_featured) : ?>
                                    <li class="noo-li-icon"><i  class="fa fa-check-circle"></i> <?php esc_html_e('Featured Company', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                            ...
                            <?php if (!empty($package->post_content)) : ?>
                                <a href="javascript:void(0)" class="readmore package-modal" data-toggle="modal" data-target="#package-content-<?php echo $package->ID; ?>"><i  class="fa fa-arrow-circle-right"></i><?php echo __('More info', 'noo'); ?>
                                </a>
                            <?php endif; ?>
                        </div>
                        <?php
