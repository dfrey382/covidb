<div class="noo-topbar">
	<div class="container-boxed max">
		...
		if ( ! empty( $topbar_text ) ): ?>
			<div
				class="noo-topbar-text pull-<?php echo esc_attr( $topbar_layout == 'right' ? 'left' : 'right' ); ?>"><?php echo $topbar_text; ?></div>
		<?php endif; ?>
							...
							<?php if ( Noo_Member::is_employer() ): ?>
								...
								<?php if ( in_array( 'manage-job', $employer_menu_values ) or empty( $employer_menu_values ) ) : ?>
									<li class="menu-item"><a
											href="<?php echo Noo_Member::get_endpoint_url( 'manage-job' ) ?>"><i class="far fa-file-alt"></i> <?php _e( 'Manage Jobs', 'noo' ) ?></a>
									</li>
								<?php endif; ?>
