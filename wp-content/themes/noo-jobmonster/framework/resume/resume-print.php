...
function noo_create_print_resume()
{
    ...
    $custom_css = wp_get_upload_dir();
    $url = isset($custom_css['baseurl']) ? $custom_css['baseurl'] : '';
    ?>
    ...
    <link rel="stylesheet" href="<?php echo $url .'/noo_jobmonster/custom.css';?>" type="text/css"
          media="all" >
