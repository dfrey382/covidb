...
if ( ! function_exists( 'noo_customizer_register_options_job' ) ) :
	function noo_customizer_register_options_job( $wp_customize ) {
		...
		$helper->add_control(
			...
			1,
			array(
			    'json' => array('on_child_options'=> 'noo_show_job_location_search,noo_show_job_category_search,noo_show_job_address,noo_show_job_page_title,noo_job_search_field_type,noo_job_heading_text'),
            ),
			array( 'transport' => 'postMessage' )
		);
