    ...
    */
    private function noo_counter_option()
    {
        ...
        $this->add_control(
        	'color_icon',
        	[
        		'label'  => esc_html__('Icon Color', 'fitsica'),
        		'type'   => Controls_Manager::COLOR,
        		'selectors' => [
        			'{{WRAPPER}} .noo-counter-icon .noo-counter-item i' => 'color: {{VALUE}}',
        		],
        	]
        );
        $this->add_control(
        	'color_text',
        	[
        		'label'  => esc_html__('Number Color', 'fitsica'),
        		'type'   => Controls_Manager::COLOR,
        		'selectors' => [
        ...
        $this->add_control(
           'color_label',
           [
               'label'  => esc_html__('Label Color', 'fitsica'),
               'type'   => Controls_Manager::COLOR,
               'selectors' => [
        ...
        if (!empty($settings['data'])) {
            switch ($settings['data']) {
                ...
                case 'all_resume' :
                    ...
                    $number_show = (\Noo_Resume::count_viewable_resumes( '', true ) + $resume_count->pending);
